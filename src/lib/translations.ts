...
export const translations = {
  en: {
    home: {
      ...
      code: {
        comment1: "// Creating amazing experiences",
        comment2: "// You can also see it on my GitHub page",
    ...
    contactForm: {
      ...
      toast: {
        fillAllFields: "Fill in all fields before sending!",
        nameMessageRequired: "Name and message are required to send via WhatsApp!",
        redirectingEmail: "Redirecting to email...",
        openingWhatsApp: "Opening WhatsApp...",
      },
      thankYou: {
        title: "Thank You!",
        message: "Your message has been accepted. You will receive an answer really soon!",
...
But life isn’t just about coding, right? In my free time, I enjoy traveling, playing sports, gaming, and, of course, spending quality time with my family and my dog. 🚀`
  ...
  pt: {
    home: {
      ...
      location: "Sapucaia do Sul - RS / Brasil",
      availability: "Disponível para novos projetos",
      code: {
        comment1: "// Criando experiências incríveis",
        comment2: "// Você também pode ver em meu GitHub",
        githubLinkText: "const githubLink = ",
        githubLinkUrl: '"https://github.com/BCaceress"',
      },
    },
    ...
    contactForm: {
      ...
      toast: {
        ...
        nameMessageRequired: "Nome e mensagem são obrigatórios para enviar via WhatsApp!",
        redirectingEmail: "Redirecionando para o e-mail...",
        openingWhatsApp: "Abrindo WhatsApp...",
      },
      thankYou: {
        title: "Obrigado!",
        message: "Sua mensagem foi enviada. Em breve você receberá uma resposta!",
