  ...
  return (
    <section className="flex flex-col items-center justify-center px-8 py-20 min-h-screen text-center bg-white dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white transition-colors duration-300 relative">
      ...
      <div className="max-w-3xl">
        ...
        <div className="mt-8 text-xl font-mono text-gray-800 dark:text-gray-300 bg-gray-900 dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700">
          <div className="bg-gray-700 text-white px-4 py-2 rounded-t-lg flex items-center space-x-2">
            <span className="w-3 h-3 bg-red-500 rounded-full"></span>
            <span className="w-3 h-3 bg-yellow-500 rounded-full"></span>
            <span className="w-3 h-3 bg-green-500 rounded-full"></span>
          </div>
          <div className="p-4 text-green-400">
            <p>// Criando experiências incríveis</p>
