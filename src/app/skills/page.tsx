...
export default function Skills() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen px-4 py-6 bg-white dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white transition-colors duration-300">
            <h2 className="text-3xl md:text-4xl text-blue-500 dark:text-blue-400 font-semibold mb-3">{"> "} Skills</h2>
            <p className="text-center mb-12 text-lg text-gray-700 dark:text-gray-300">The skills, tools, and technologies I am really good at:</p>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-8">
                {skills.map((skill, index) => (
                    <div key={index} className="flex flex-col items-center space-y-4 transform transition duration-500 hover:scale-105">
                        <Image 
