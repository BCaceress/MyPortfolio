...
export default function Skills() {
  ...
  // Utiliza a tradução do idioma atual; se não existir, utiliza o inglês como fallback
  ...
  const skills = [
    ...
    { name: "MySQL", logo: "/images/icon-mysql.svg" },
  ];
        ...
        {skills.map((skill, index) => (
          ...
          >
            <Image
              ...
              src={skill.logo}
              alt={skill.name}
              width={skill.name === "MySQL" ? 60 : 60}
              height={skill.name === "MySQL" ? 80 : 80}
              style={{
                maxWidth: skill.name === "MySQL" ? "60px" : "60px",
                maxHeight: skill.name === "MySQL" ? "60px" : "60px",
                objectFit: "contain",
              }}
            />
